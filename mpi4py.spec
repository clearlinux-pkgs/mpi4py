...
Source0  : https://github.com/mpi4py/mpi4py/releases/download/3.1.4/mpi4py-3.1.4.tar.gz
...
%prep
%setup -q -n mpi4py-3.1.4
cd %{_builddir}/mpi4py-3.1.4
pushd ..
cp -a mpi4py-3.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687214642
